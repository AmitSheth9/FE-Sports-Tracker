...
<div>
    <div className='intro-container'>
        {!auth.username && <span className='guest-status'>Login as U: guest and PW: guest to see a sample</span>}
        {auth.username ? 
        <span className='login-status'>You are logged in as {auth.username}</span> : 
        <span className='login-status'><Link to='/login'>Login here</Link> or <Link to='/signup'>Signup here</Link></span>}<br/>
         </div>
        ...
        <div className='div-conditional-container'> 
            ...
            if (firstDropValue === 'Spread') {
                ...
                <div className='div-total'>
                    ...
                    <label className='label-total-price'>Price:
                    <select 
                        value={priceDropValue} 
                        onChange={(e) => setPriceDropValue(e.target.value)}>
                        {juiceArr.map((num => {
